...
export default function Paper() {
  ...
  const [kursi, setKursi] = useState('react');
  ...
  return (
    <View style={styles.container}>
      ...
      <Appbar.Header>
        ...
        <Appbar.Action icon='account' onPress={() => alert("Profile")} />
      </Appbar.Header>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        {/* Avatar */}
        <Text variant='titleMedium' style={styles.sectionTitle}>Avatar</Text>
        ...
        {/* Buttons */}
        <Text variant='titleMedium' style={styles.sectionTitle}>Button</Text>
        ...
        {/* Card */}
        <Text variant='titleMedium' style={styles.sectionTitle}>Card</Text>

        <Card style={styles.card}>
          <Card.Title title="Kursi i programimit" subtitle="React Native" />
          <Card.Content>
            <Text variant="bodyMedium">
              Ky eshte nje shembull i nje card ne react native paper
            </Text>
          </Card.Content>
          <Card.Actions>
        ...
        <RadioButton.Group
          ...
          value={kursi}>
          <RadioButton.Item label="React Native" value="react" />
          <RadioButton.Item label="PHP" value="php" />
          <RadioButton.Item label="Python" value="python" />
        </RadioButton.Group>

        {/* Chip */}
        <Text variant="titleMedium" style={styles.sectionTitle}>Chip</Text>

        <View style={styles.rowWrap}>
          <Chip icon="language-javascript" style={styles.chip}>JavaScript</Chip>
          <Chip icon="language-php" style={styles.chip}>PHP</Chip>
          <Chip icon="language-python" style={styles.chip}>Python</Chip>
          <Chip icon="language-java" style={styles.chip}>Java</Chip>
          <Chip icon="language-c" style={styles.chip}>C</Chip>
        </View>

        {/* Menu */}
        <Text variant='titleMedium' style={styles.sectionTitle}>Menu</Text>
        ...
        {/* Dialog */}
        <Text variant="titleMedium" style={styles.sectionTitle}>Dialog</Text>
